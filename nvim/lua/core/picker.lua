...
vim.keymap.set("n", "<leader>fw", ":lua Snacks.picker.grep()<CR>", { silent = true })
vim.keymap.set("n", "<leader>fb", ":lua Snacks.picker.buffers()<CR>", { silent = true })

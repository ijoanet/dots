...
vim.api.nvim_create_autocmd("LspAttach", {
  ...
  callback = function(args)
    ...
    if client:supports_method("textDocument/formatting") then
      ...
      end, { buffer = args.buf, desc = "LSP: Format current buffer" })
    end
    ...
    if client:supports_method('textDocument/codeAction') then
      vim.keymap.set({ 'n', 'v' }, '<leader>ga', vim.lsp.buf.code_action, { buffer = args.buf, desc = 'Code action' })
    end
    ...
    if client:supports_method('workspace/symbol') then
      ...
      -- vim.keymap.set('n', '<leader>ws', vim.lsp.buf.workspace_symbols,
    ...
    vim.keymap.set('n', '<leader>e', vim.diagnostic.open_float, { buffer = args.buf, desc = 'Float diagnostic' })
    vim.keymap.set('n', '<leader>q', vim.diagnostic.setloclist, { buffer = args.buf, desc = 'Location list' })
  end,
})
